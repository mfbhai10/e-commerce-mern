...
const AdminProductsPage = () => {
  ...
  const loadData = async () => {
    try {
      ...
      setError(
        requestError?.response?.data?.message || "Unable to load product data.",
      );
    } finally {
      setLoading(false);
    }
            ...
            <div className="form-grid">
              ...
              <label className="form-field form-field--full">
                ...
                <textarea
                  ...
                  onChange={handleFieldChange("attributes")}
                  rows="4"
                  placeholder='{"color":"Black","material":"Cotton"}'
                />
              </label>
              <label className="form-field">
              ...
              <label className="form-field">
                ...
                <input
                  ...
                  onChange={handleStockChange("reserved")}
                />
              </label>
              <label className="form-field">
                ...
                <input
                  ...
                  onChange={handleStockChange("lowStockThreshold")}
                />
              </label>
              <label className="form-field">
                <span>Track inventory</span>
                <select
                  value={form.stock.trackInventory ? "true" : "false"}
                  onChange={(event) =>
                    setForm((current) => ({
                      ...current,
                      stock: {
                        ...current.stock,
                        trackInventory: event.target.value === "true",
                      },
                    }))
                  }
                >
              ...
              <label className="form-field form-field--full">
                ...
                <span className="form-help">
                  Upload one or more images. New uploads will be sent to
                  Cloudinary.
                </span>
              </label>
